...
[ -f "$CACHE/belgium-260702.osm.pbf" ] || wcurl -o $CACHE/belgium-260702.osm.pbf https://download.geofabrik.de/europe/belgium-260702.osm.pbf
echo belgium-260702.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260702.osm.pbf" ] || wcurl -o $CACHE/netherlands-260702.osm.pbf https://download.geofabrik.de/europe/netherlands-260702.osm.pbf
echo netherlands-260702.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260702.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260702.osm.pbf https://download.geofabrik.de/europe/luxembourg-260702.osm.pbf
echo luxembourg-260702.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/322efc-655aae544b4ac.zip" ] || wcurl -o $CACHE/322efc-655aae544b4ac.zip http://download.geonames.org/export/dump/cities15000.zip
echo 322efc-655aae544b4ac.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
