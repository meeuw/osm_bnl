...
[ -f "$CACHE/sea-20260807220000.zip" ] || wcurl -o $CACHE/sea-20260807220000.zip http://osm.thkukuk.de/data/sea-20260807220000.zip
echo sea-20260807220000.zip > names/sea
...
[ -f "$CACHE/326f4c-6589444257df2.zip" ] || wcurl -o $CACHE/326f4c-6589444257df2.zip http://download.geonames.org/export/dump/cities15000.zip
echo 326f4c-6589444257df2.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
