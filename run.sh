...
[ -f "$CACHE/belgium-260518.osm.pbf" ] || wcurl -o $CACHE/belgium-260518.osm.pbf https://download.geofabrik.de/europe/belgium-260518.osm.pbf
echo belgium-260518.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260518.osm.pbf" ] || wcurl -o $CACHE/netherlands-260518.osm.pbf https://download.geofabrik.de/europe/netherlands-260518.osm.pbf
echo netherlands-260518.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260518.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260518.osm.pbf https://download.geofabrik.de/europe/luxembourg-260518.osm.pbf
echo luxembourg-260518.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/31ed0d-65221cae4951c.zip" ] || wcurl -o $CACHE/31ed0d-65221cae4951c.zip http://download.geonames.org/export/dump/cities15000.zip
echo 31ed0d-65221cae4951c.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
