...
[ -f "$CACHE/belgium-260814.osm.pbf" ] || wcurl -o $CACHE/belgium-260814.osm.pbf https://download.geofabrik.de/europe/belgium-260814.osm.pbf
echo belgium-260814.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260814.osm.pbf" ] || wcurl -o $CACHE/netherlands-260814.osm.pbf https://download.geofabrik.de/europe/netherlands-260814.osm.pbf
echo netherlands-260814.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260815.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260815.osm.pbf https://download.geofabrik.de/europe/luxembourg-260815.osm.pbf
echo luxembourg-260815.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/sea-20260814220000.zip" ] || wcurl -o $CACHE/sea-20260814220000.zip http://osm.thkukuk.de/data/sea-20260814220000.zip
echo sea-20260814220000.zip > names/sea
...
[ -f "$CACHE/3273cd-6590c8be06b08.zip" ] || wcurl -o $CACHE/3273cd-6590c8be06b08.zip http://download.geonames.org/export/dump/cities15000.zip
echo 3273cd-6590c8be06b08.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
