...
[ -f "$CACHE/belgium-260425.osm.pbf" ] || wcurl -o $CACHE/belgium-260425.osm.pbf https://download.geofabrik.de/europe/belgium-260425.osm.pbf
echo belgium-260425.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260425.osm.pbf" ] || wcurl -o $CACHE/netherlands-260425.osm.pbf https://download.geofabrik.de/europe/netherlands-260425.osm.pbf
echo netherlands-260425.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260425.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260425.osm.pbf https://download.geofabrik.de/europe/luxembourg-260425.osm.pbf
echo luxembourg-260425.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/sea-20260424220000.zip" ] || wcurl -o $CACHE/sea-20260424220000.zip http://osm.thkukuk.de/data/sea-20260424220000.zip
echo sea-20260424220000.zip > names/sea
...
[ -f "$CACHE/31c644-65053ad2f60cf.zip" ] || wcurl -o $CACHE/31c644-65053ad2f60cf.zip http://download.geonames.org/export/dump/cities15000.zip
echo 31c644-65053ad2f60cf.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
