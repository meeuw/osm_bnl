...
[ -f "$CACHE/belgium-260601.osm.pbf" ] || wcurl -o $CACHE/belgium-260601.osm.pbf https://download.geofabrik.de/europe/belgium-260601.osm.pbf
echo belgium-260601.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260601.osm.pbf" ] || wcurl -o $CACHE/netherlands-260601.osm.pbf https://download.geofabrik.de/europe/netherlands-260601.osm.pbf
echo netherlands-260601.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260601.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260601.osm.pbf https://download.geofabrik.de/europe/luxembourg-260601.osm.pbf
echo luxembourg-260601.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/31fa4b-6533b4dbb1ca4.zip" ] || wcurl -o $CACHE/31fa4b-6533b4dbb1ca4.zip http://download.geonames.org/export/dump/cities15000.zip
echo 31fa4b-6533b4dbb1ca4.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
