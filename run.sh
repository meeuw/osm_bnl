...
[ -f "$CACHE/belgium-260818.osm.pbf" ] || wcurl -o $CACHE/belgium-260818.osm.pbf https://download.geofabrik.de/europe/belgium-260818.osm.pbf
echo belgium-260818.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260818.osm.pbf" ] || wcurl -o $CACHE/netherlands-260818.osm.pbf https://download.geofabrik.de/europe/netherlands-260818.osm.pbf
echo netherlands-260818.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260818.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260818.osm.pbf https://download.geofabrik.de/europe/luxembourg-260818.osm.pbf
echo luxembourg-260818.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/sea-20260817220000.zip" ] || wcurl -o $CACHE/sea-20260817220000.zip http://osm.thkukuk.de/data/sea-20260817220000.zip
echo sea-20260817220000.zip > names/sea
...
[ -f "$CACHE/327468-6595cb9b7a5b7.zip" ] || wcurl -o $CACHE/327468-6595cb9b7a5b7.zip http://download.geonames.org/export/dump/cities15000.zip
echo 327468-6595cb9b7a5b7.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
