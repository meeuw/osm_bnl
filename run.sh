...
[ -f "$CACHE/belgium-260701.osm.pbf" ] || wcurl -o $CACHE/belgium-260701.osm.pbf https://download.geofabrik.de/europe/belgium-260701.osm.pbf
echo belgium-260701.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260701.osm.pbf" ] || wcurl -o $CACHE/netherlands-260701.osm.pbf https://download.geofabrik.de/europe/netherlands-260701.osm.pbf
echo netherlands-260701.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260701.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260701.osm.pbf https://download.geofabrik.de/europe/luxembourg-260701.osm.pbf
echo luxembourg-260701.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/322e48-65596cb4929a5.zip" ] || wcurl -o $CACHE/322e48-65596cb4929a5.zip http://download.geonames.org/export/dump/cities15000.zip
echo 322e48-65596cb4929a5.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
