...
[ -f "$CACHE/belgium-260918.osm.pbf" ] || wcurl -o $CACHE/belgium-260918.osm.pbf https://download.geofabrik.de/europe/belgium-260918.osm.pbf
echo belgium-260918.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260918.osm.pbf" ] || wcurl -o $CACHE/netherlands-260918.osm.pbf https://download.geofabrik.de/europe/netherlands-260918.osm.pbf
echo netherlands-260918.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260918.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260918.osm.pbf https://download.geofabrik.de/europe/luxembourg-260918.osm.pbf
echo luxembourg-260918.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/sea-20260917220000.zip" ] || wcurl -o $CACHE/sea-20260917220000.zip http://osm.thkukuk.de/data/sea-20260917220000.zip
echo sea-20260917220000.zip > names/sea
...
[ -f "$CACHE/334287-65bcc4c83514a.zip" ] || wcurl -o $CACHE/334287-65bcc4c83514a.zip http://download.geonames.org/export/dump/cities15000.zip
echo 334287-65bcc4c83514a.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
