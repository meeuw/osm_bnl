...
[ -f "$CACHE/belgium-260507.osm.pbf" ] || wcurl -o $CACHE/belgium-260507.osm.pbf https://download.geofabrik.de/europe/belgium-260507.osm.pbf
echo belgium-260507.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260507.osm.pbf" ] || wcurl -o $CACHE/netherlands-260507.osm.pbf https://download.geofabrik.de/europe/netherlands-260507.osm.pbf
echo netherlands-260507.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260507.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260507.osm.pbf https://download.geofabrik.de/europe/luxembourg-260507.osm.pbf
echo luxembourg-260507.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/31dae3-651447a3f9bb0.zip" ] || wcurl -o $CACHE/31dae3-651447a3f9bb0.zip http://download.geonames.org/export/dump/cities15000.zip
echo 31dae3-651447a3f9bb0.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
