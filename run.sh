...
[ -f "$CACHE/belgium-260330.osm.pbf" ] || wcurl -o $CACHE/belgium-260330.osm.pbf https://download.geofabrik.de/europe/belgium-260330.osm.pbf
echo belgium-260330.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260330.osm.pbf" ] || wcurl -o $CACHE/netherlands-260330.osm.pbf https://download.geofabrik.de/europe/netherlands-260330.osm.pbf
echo netherlands-260330.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260330.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260330.osm.pbf https://download.geofabrik.de/europe/luxembourg-260330.osm.pbf
echo luxembourg-260330.osm.pbf > names/geofabrik-luxembourg
[ -f "$CACHE/bounds-20260327.zip" ] || wcurl -o $CACHE/bounds-20260327.zip http://osm.thkukuk.de/data/bounds-20260327.zip
echo bounds-20260327.zip > names/bounds
[ -f "$CACHE/sea-20260330220000.zip" ] || wcurl -o $CACHE/sea-20260330220000.zip http://osm.thkukuk.de/data/sea-20260330220000.zip
echo sea-20260330220000.zip > names/sea
...
[ -f "$CACHE/2ef89f-64e5c13081d2c.zip" ] || wcurl -o $CACHE/2ef89f-64e5c13081d2c.zip http://download.geonames.org/export/dump/cities15000.zip
echo 2ef89f-64e5c13081d2c.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
