...
[ -f "$CACHE/belgium-260310.osm.pbf" ] || wcurl -o $CACHE/belgium-260310.osm.pbf https://download.geofabrik.de/europe/belgium-260310.osm.pbf
echo belgium-260310.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260310.osm.pbf" ] || wcurl -o $CACHE/netherlands-260310.osm.pbf https://download.geofabrik.de/europe/netherlands-260310.osm.pbf
echo netherlands-260310.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260311.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260311.osm.pbf https://download.geofabrik.de/europe/luxembourg-260311.osm.pbf
echo luxembourg-260311.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/sea-20260310230000.zip" ] || wcurl -o $CACHE/sea-20260310230000.zip http://osm.thkukuk.de/data/sea-20260310230000.zip
echo sea-20260310230000.zip > names/sea
...
[ -f "$CACHE/2ed2be-64cca9c1c251a.zip" ] || wcurl -o $CACHE/2ed2be-64cca9c1c251a.zip http://download.geonames.org/export/dump/cities15000.zip
echo 2ed2be-64cca9c1c251a.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
