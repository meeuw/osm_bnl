...
[ -f "$CACHE/belgium-260406.osm.pbf" ] || wcurl -o $CACHE/belgium-260406.osm.pbf https://download.geofabrik.de/europe/belgium-260406.osm.pbf
echo belgium-260406.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260406.osm.pbf" ] || wcurl -o $CACHE/netherlands-260406.osm.pbf https://download.geofabrik.de/europe/netherlands-260406.osm.pbf
echo netherlands-260406.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260406.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260406.osm.pbf https://download.geofabrik.de/europe/luxembourg-260406.osm.pbf
echo luxembourg-260406.osm.pbf > names/geofabrik-luxembourg
[ -f "$CACHE/bounds-20260403.zip" ] || wcurl -o $CACHE/bounds-20260403.zip http://osm.thkukuk.de/data/bounds-20260403.zip
echo bounds-20260403.zip > names/bounds
[ -f "$CACHE/sea-20260405220000.zip" ] || wcurl -o $CACHE/sea-20260405220000.zip http://osm.thkukuk.de/data/sea-20260405220000.zip
echo sea-20260405220000.zip > names/sea
...
[ -f "$CACHE/2efbb6-64ed4c735e5b5.zip" ] || wcurl -o $CACHE/2efbb6-64ed4c735e5b5.zip http://download.geonames.org/export/dump/cities15000.zip
echo 2efbb6-64ed4c735e5b5.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
