...
[ -f "$CACHE/belgium-260628.osm.pbf" ] || wcurl -o $CACHE/belgium-260628.osm.pbf https://download.geofabrik.de/europe/belgium-260628.osm.pbf
echo belgium-260628.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260628.osm.pbf" ] || wcurl -o $CACHE/netherlands-260628.osm.pbf https://download.geofabrik.de/europe/netherlands-260628.osm.pbf
echo netherlands-260628.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260628.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260628.osm.pbf https://download.geofabrik.de/europe/luxembourg-260628.osm.pbf
echo luxembourg-260628.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/3226db-6555a76909b57.zip" ] || wcurl -o $CACHE/3226db-6555a76909b57.zip http://download.geonames.org/export/dump/cities15000.zip
echo 3226db-6555a76909b57.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
