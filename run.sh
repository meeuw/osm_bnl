...
[ -f "$CACHE/belgium-260630.osm.pbf" ] || wcurl -o $CACHE/belgium-260630.osm.pbf https://download.geofabrik.de/europe/belgium-260630.osm.pbf
echo belgium-260630.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260630.osm.pbf" ] || wcurl -o $CACHE/netherlands-260630.osm.pbf https://download.geofabrik.de/europe/netherlands-260630.osm.pbf
echo netherlands-260630.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260630.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260630.osm.pbf https://download.geofabrik.de/europe/luxembourg-260630.osm.pbf
echo luxembourg-260630.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/322bbb-65582b401b7fa.zip" ] || wcurl -o $CACHE/322bbb-65582b401b7fa.zip http://download.geonames.org/export/dump/cities15000.zip
echo 322bbb-65582b401b7fa.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
