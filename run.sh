...
[ -f "$CACHE/belgium-260325.osm.pbf" ] || wcurl -o $CACHE/belgium-260325.osm.pbf https://download.geofabrik.de/europe/belgium-260325.osm.pbf
echo belgium-260325.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260325.osm.pbf" ] || wcurl -o $CACHE/netherlands-260325.osm.pbf https://download.geofabrik.de/europe/netherlands-260325.osm.pbf
echo netherlands-260325.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260325.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260325.osm.pbf https://download.geofabrik.de/europe/luxembourg-260325.osm.pbf
echo luxembourg-260325.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/sea-20260324230000.zip" ] || wcurl -o $CACHE/sea-20260324230000.zip http://osm.thkukuk.de/data/sea-20260324230000.zip
echo sea-20260324230000.zip > names/sea
...
[ -f "$CACHE/2ee2c5-64de437b5021e.zip" ] || wcurl -o $CACHE/2ee2c5-64de437b5021e.zip http://download.geonames.org/export/dump/cities15000.zip
echo 2ee2c5-64de437b5021e.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
