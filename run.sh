...
[ -f "$CACHE/belgium-260914.osm.pbf" ] || wcurl -o $CACHE/belgium-260914.osm.pbf https://download.geofabrik.de/europe/belgium-260914.osm.pbf
echo belgium-260914.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260914.osm.pbf" ] || wcurl -o $CACHE/netherlands-260914.osm.pbf https://download.geofabrik.de/europe/netherlands-260914.osm.pbf
echo netherlands-260914.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260914.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260914.osm.pbf https://download.geofabrik.de/europe/luxembourg-260914.osm.pbf
echo luxembourg-260914.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/sea-20260913220000.zip" ] || wcurl -o $CACHE/sea-20260913220000.zip http://osm.thkukuk.de/data/sea-20260913220000.zip
echo sea-20260913220000.zip > names/sea
...
[ -f "$CACHE/32ffd6-65b7bc98005e6.zip" ] || wcurl -o $CACHE/32ffd6-65b7bc98005e6.zip http://download.geonames.org/export/dump/cities15000.zip
echo 32ffd6-65b7bc98005e6.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
