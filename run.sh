...
[ -f "$CACHE/belgium-260304.osm.pbf" ] || wcurl -o $CACHE/belgium-260304.osm.pbf https://download.geofabrik.de/europe/belgium-260304.osm.pbf
echo belgium-260304.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260304.osm.pbf" ] || wcurl -o $CACHE/netherlands-260304.osm.pbf https://download.geofabrik.de/europe/netherlands-260304.osm.pbf
echo netherlands-260304.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260304.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260304.osm.pbf https://download.geofabrik.de/europe/luxembourg-260304.osm.pbf
echo luxembourg-260304.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/sea-20260303230000.zip" ] || wcurl -o $CACHE/sea-20260303230000.zip http://osm.thkukuk.de/data/sea-20260303230000.zip
echo sea-20260303230000.zip > names/sea
...
[ -f "$CACHE/2ec8ff-64c3e0b42ab1a.zip" ] || wcurl -o $CACHE/2ec8ff-64c3e0b42ab1a.zip http://download.geonames.org/export/dump/cities15000.zip
echo 2ec8ff-64c3e0b42ab1a.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
