...
[ -f "$CACHE/belgium-260729.osm.pbf" ] || wcurl -o $CACHE/belgium-260729.osm.pbf https://download.geofabrik.de/europe/belgium-260729.osm.pbf
echo belgium-260729.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260729.osm.pbf" ] || wcurl -o $CACHE/netherlands-260729.osm.pbf https://download.geofabrik.de/europe/netherlands-260729.osm.pbf
echo netherlands-260729.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260729.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260729.osm.pbf https://download.geofabrik.de/europe/luxembourg-260729.osm.pbf
echo luxembourg-260729.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/326469-657ca2274ebae.zip" ] || wcurl -o $CACHE/326469-657ca2274ebae.zip http://download.geonames.org/export/dump/cities15000.zip
echo 326469-657ca2274ebae.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
