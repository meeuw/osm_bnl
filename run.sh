...
[ -f "$CACHE/belgium-260312.osm.pbf" ] || wcurl -o $CACHE/belgium-260312.osm.pbf https://download.geofabrik.de/europe/belgium-260312.osm.pbf
echo belgium-260312.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260312.osm.pbf" ] || wcurl -o $CACHE/netherlands-260312.osm.pbf https://download.geofabrik.de/europe/netherlands-260312.osm.pbf
echo netherlands-260312.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260312.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260312.osm.pbf https://download.geofabrik.de/europe/luxembourg-260312.osm.pbf
echo luxembourg-260312.osm.pbf > names/geofabrik-luxembourg
[ -f "$CACHE/bounds-20260306.zip" ] || wcurl -o $CACHE/bounds-20260306.zip http://osm.thkukuk.de/data/bounds-20260306.zip
echo bounds-20260306.zip > names/bounds
[ -f "$CACHE/sea-20260311230000.zip" ] || wcurl -o $CACHE/sea-20260311230000.zip http://osm.thkukuk.de/data/sea-20260311230000.zip
echo sea-20260311230000.zip > names/sea
...
[ -f "$CACHE/2ed2e7-64cdeb3773b15.zip" ] || wcurl -o $CACHE/2ed2e7-64cdeb3773b15.zip http://download.geonames.org/export/dump/cities15000.zip
echo 2ed2e7-64cdeb3773b15.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
