...
[ -f "$CACHE/belgium-260801.osm.pbf" ] || wcurl -o $CACHE/belgium-260801.osm.pbf https://download.geofabrik.de/europe/belgium-260801.osm.pbf
echo belgium-260801.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260801.osm.pbf" ] || wcurl -o $CACHE/netherlands-260801.osm.pbf https://download.geofabrik.de/europe/netherlands-260801.osm.pbf
echo netherlands-260801.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260801.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260801.osm.pbf https://download.geofabrik.de/europe/luxembourg-260801.osm.pbf
echo luxembourg-260801.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/sea-20260731220000.zip" ] || wcurl -o $CACHE/sea-20260731220000.zip http://osm.thkukuk.de/data/sea-20260731220000.zip
echo sea-20260731220000.zip > names/sea
...
[ -f "$CACHE/326a5e-65806eafa5858.zip" ] || wcurl -o $CACHE/326a5e-65806eafa5858.zip http://download.geonames.org/export/dump/cities15000.zip
echo 326a5e-65806eafa5858.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
