...
[ -f "$CACHE/belgium-260613.osm.pbf" ] || wcurl -o $CACHE/belgium-260613.osm.pbf https://download.geofabrik.de/europe/belgium-260613.osm.pbf
echo belgium-260613.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260613.osm.pbf" ] || wcurl -o $CACHE/netherlands-260613.osm.pbf https://download.geofabrik.de/europe/netherlands-260613.osm.pbf
echo netherlands-260613.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260613.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260613.osm.pbf https://download.geofabrik.de/europe/luxembourg-260613.osm.pbf
echo luxembourg-260613.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/320dbf-6542d1c37e4f8.zip" ] || wcurl -o $CACHE/320dbf-6542d1c37e4f8.zip http://download.geonames.org/export/dump/cities15000.zip
echo 320dbf-6542d1c37e4f8.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
