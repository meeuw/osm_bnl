...
[ -f "$CACHE/belgium-260802.osm.pbf" ] || wcurl -o $CACHE/belgium-260802.osm.pbf https://download.geofabrik.de/europe/belgium-260802.osm.pbf
echo belgium-260802.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260802.osm.pbf" ] || wcurl -o $CACHE/netherlands-260802.osm.pbf https://download.geofabrik.de/europe/netherlands-260802.osm.pbf
echo netherlands-260802.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260802.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260802.osm.pbf https://download.geofabrik.de/europe/luxembourg-260802.osm.pbf
echo luxembourg-260802.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/sea-20260801220000.zip" ] || wcurl -o $CACHE/sea-20260801220000.zip http://osm.thkukuk.de/data/sea-20260801220000.zip
echo sea-20260801220000.zip > names/sea
...
[ -f "$CACHE/326bfa-6581a92fb2aaf.zip" ] || wcurl -o $CACHE/326bfa-6581a92fb2aaf.zip http://download.geonames.org/export/dump/cities15000.zip
echo 326bfa-6581a92fb2aaf.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
