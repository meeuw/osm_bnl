...
[ -f "$CACHE/belgium-260625.osm.pbf" ] || wcurl -o $CACHE/belgium-260625.osm.pbf https://download.geofabrik.de/europe/belgium-260625.osm.pbf
echo belgium-260625.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260625.osm.pbf" ] || wcurl -o $CACHE/netherlands-260625.osm.pbf https://download.geofabrik.de/europe/netherlands-260625.osm.pbf
...
[ -f "$CACHE/322589-6551e128b410d.zip" ] || wcurl -o $CACHE/322589-6551e128b410d.zip http://download.geonames.org/export/dump/cities15000.zip
echo 322589-6551e128b410d.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
