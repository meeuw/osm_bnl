...
[ -f "$CACHE/belgium-260522.osm.pbf" ] || wcurl -o $CACHE/belgium-260522.osm.pbf https://download.geofabrik.de/europe/belgium-260522.osm.pbf
echo belgium-260522.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260522.osm.pbf" ] || wcurl -o $CACHE/netherlands-260522.osm.pbf https://download.geofabrik.de/europe/netherlands-260522.osm.pbf
echo netherlands-260522.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260522.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260522.osm.pbf https://download.geofabrik.de/europe/luxembourg-260522.osm.pbf
echo luxembourg-260522.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/31f6a3-652722db176df.zip" ] || wcurl -o $CACHE/31f6a3-652722db176df.zip http://download.geonames.org/export/dump/cities15000.zip
echo 31f6a3-652722db176df.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
