...
[ -f "$CACHE/luxembourg-260309.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260309.osm.pbf https://download.geofabrik.de/europe/luxembourg-260309.osm.pbf
echo luxembourg-260309.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/sea-20260308230000.zip" ] || wcurl -o $CACHE/sea-20260308230000.zip http://osm.thkukuk.de/data/sea-20260308230000.zip
echo sea-20260308230000.zip > names/sea
...
[ -f "$CACHE/2ed0b8-64ca25cb2b029.zip" ] || wcurl -o $CACHE/2ed0b8-64ca25cb2b029.zip http://download.geonames.org/export/dump/cities15000.zip
echo 2ed0b8-64ca25cb2b029.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
