...
[ -f "$CACHE/belgium-260506.osm.pbf" ] || wcurl -o $CACHE/belgium-260506.osm.pbf https://download.geofabrik.de/europe/belgium-260506.osm.pbf
echo belgium-260506.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260506.osm.pbf" ] || wcurl -o $CACHE/netherlands-260506.osm.pbf https://download.geofabrik.de/europe/netherlands-260506.osm.pbf
echo netherlands-260506.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260506.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260506.osm.pbf https://download.geofabrik.de/europe/luxembourg-260506.osm.pbf
echo luxembourg-260506.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/31d9b3-6513042bea856.zip" ] || wcurl -o $CACHE/31d9b3-6513042bea856.zip http://download.geonames.org/export/dump/cities15000.zip
echo 31d9b3-6513042bea856.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
