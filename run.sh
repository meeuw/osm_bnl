...
[ -f "$CACHE/belgium-260404.osm.pbf" ] || wcurl -o $CACHE/belgium-260404.osm.pbf https://download.geofabrik.de/europe/belgium-260404.osm.pbf
echo belgium-260404.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260404.osm.pbf" ] || wcurl -o $CACHE/netherlands-260404.osm.pbf https://download.geofabrik.de/europe/netherlands-260404.osm.pbf
echo netherlands-260404.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260405.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260405.osm.pbf https://download.geofabrik.de/europe/luxembourg-260405.osm.pbf
echo luxembourg-260405.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/sea-20260404220000.zip" ] || wcurl -o $CACHE/sea-20260404220000.zip http://osm.thkukuk.de/data/sea-20260404220000.zip
echo sea-20260404220000.zip > names/sea
...
[ -f "$CACHE/2efc81-64ec0a2a85e5d.zip" ] || wcurl -o $CACHE/2efc81-64ec0a2a85e5d.zip http://download.geonames.org/export/dump/cities15000.zip
echo 2efc81-64ec0a2a85e5d.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
