...
[ -f "$CACHE/belgium-260516.osm.pbf" ] || wcurl -o $CACHE/belgium-260516.osm.pbf https://download.geofabrik.de/europe/belgium-260516.osm.pbf
echo belgium-260516.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260516.osm.pbf" ] || wcurl -o $CACHE/netherlands-260516.osm.pbf https://download.geofabrik.de/europe/netherlands-260516.osm.pbf
echo netherlands-260516.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260516.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260516.osm.pbf https://download.geofabrik.de/europe/luxembourg-260516.osm.pbf
echo luxembourg-260516.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/31ebfe-651fa0435c6c4.zip" ] || wcurl -o $CACHE/31ebfe-651fa0435c6c4.zip http://download.geonames.org/export/dump/cities15000.zip
echo 31ebfe-651fa0435c6c4.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
