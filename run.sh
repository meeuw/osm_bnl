...
[ -f "$CACHE/belgium-260608.osm.pbf" ] || wcurl -o $CACHE/belgium-260608.osm.pbf https://download.geofabrik.de/europe/belgium-260608.osm.pbf
echo belgium-260608.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260608.osm.pbf" ] || wcurl -o $CACHE/netherlands-260608.osm.pbf https://download.geofabrik.de/europe/netherlands-260608.osm.pbf
echo netherlands-260608.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260608.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260608.osm.pbf https://download.geofabrik.de/europe/luxembourg-260608.osm.pbf
echo luxembourg-260608.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/320325-653c819aa3f3c.zip" ] || wcurl -o $CACHE/320325-653c819aa3f3c.zip http://download.geonames.org/export/dump/cities15000.zip
echo 320325-653c819aa3f3c.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
