...
[ -f "$CACHE/sea-20260725220000.zip" ] || wcurl -o $CACHE/sea-20260725220000.zip http://osm.thkukuk.de/data/sea-20260725220000.zip
echo sea-20260725220000.zip > names/sea
...
[ -f "$CACHE/3263d0-6578dae916e80.zip" ] || wcurl -o $CACHE/3263d0-6578dae916e80.zip http://download.geonames.org/export/dump/cities15000.zip
echo 3263d0-6578dae916e80.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
