...
[ -f "$CACHE/belgium-260912.osm.pbf" ] || wcurl -o $CACHE/belgium-260912.osm.pbf https://download.geofabrik.de/europe/belgium-260912.osm.pbf
echo belgium-260912.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260912.osm.pbf" ] || wcurl -o $CACHE/netherlands-260912.osm.pbf https://download.geofabrik.de/europe/netherlands-260912.osm.pbf
echo netherlands-260912.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260912.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260912.osm.pbf https://download.geofabrik.de/europe/luxembourg-260912.osm.pbf
echo luxembourg-260912.osm.pbf > names/geofabrik-luxembourg
[ -f "$CACHE/bounds-20260911.zip" ] || wcurl -o $CACHE/bounds-20260911.zip http://osm.thkukuk.de/data/bounds-20260911.zip
echo bounds-20260911.zip > names/bounds
[ -f "$CACHE/sea-20260911220000.zip" ] || wcurl -o $CACHE/sea-20260911220000.zip http://osm.thkukuk.de/data/sea-20260911220000.zip
echo sea-20260911220000.zip > names/sea
...
[ -f "$CACHE/329829-65b54362a35bf.zip" ] || wcurl -o $CACHE/329829-65b54362a35bf.zip http://download.geonames.org/export/dump/cities15000.zip
echo 329829-65b54362a35bf.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
