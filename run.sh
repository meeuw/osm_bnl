...
[ -f "$CACHE/belgium-260417.osm.pbf" ] || wcurl -o $CACHE/belgium-260417.osm.pbf https://download.geofabrik.de/europe/belgium-260417.osm.pbf
echo belgium-260417.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260417.osm.pbf" ] || wcurl -o $CACHE/netherlands-260417.osm.pbf https://download.geofabrik.de/europe/netherlands-260417.osm.pbf
echo netherlands-260417.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260417.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260417.osm.pbf https://download.geofabrik.de/europe/luxembourg-260417.osm.pbf
echo luxembourg-260417.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/31b83a-64fb23b6a2415.zip" ] || wcurl -o $CACHE/31b83a-64fb23b6a2415.zip http://download.geonames.org/export/dump/cities15000.zip
echo 31b83a-64fb23b6a2415.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
