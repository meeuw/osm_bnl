...
[ -f "$CACHE/belgium-260621.osm.pbf" ] || wcurl -o $CACHE/belgium-260621.osm.pbf https://download.geofabrik.de/europe/belgium-260621.osm.pbf
echo belgium-260621.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260621.osm.pbf" ] || wcurl -o $CACHE/netherlands-260621.osm.pbf https://download.geofabrik.de/europe/netherlands-260621.osm.pbf
echo netherlands-260621.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260621.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260621.osm.pbf https://download.geofabrik.de/europe/luxembourg-260621.osm.pbf
echo luxembourg-260621.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/321e72-654cd9d77db13.zip" ] || wcurl -o $CACHE/321e72-654cd9d77db13.zip http://download.geonames.org/export/dump/cities15000.zip
echo 321e72-654cd9d77db13.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
