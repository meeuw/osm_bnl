...
[ -f "$CACHE/belgium-260626.osm.pbf" ] || wcurl -o $CACHE/belgium-260626.osm.pbf https://download.geofabrik.de/europe/belgium-260626.osm.pbf
echo belgium-260626.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260626.osm.pbf" ] || wcurl -o $CACHE/netherlands-260626.osm.pbf https://download.geofabrik.de/europe/netherlands-260626.osm.pbf
echo netherlands-260626.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260626.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260626.osm.pbf https://download.geofabrik.de/europe/luxembourg-260626.osm.pbf
...
[ -f "$CACHE/32258b-655322da7dae7.zip" ] || wcurl -o $CACHE/32258b-655322da7dae7.zip http://download.geonames.org/export/dump/cities15000.zip
echo 32258b-655322da7dae7.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
