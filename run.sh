...
[ -f "$CACHE/belgium-260816.osm.pbf" ] || wcurl -o $CACHE/belgium-260816.osm.pbf https://download.geofabrik.de/europe/belgium-260816.osm.pbf
echo belgium-260816.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260815.osm.pbf" ] || wcurl -o $CACHE/netherlands-260815.osm.pbf https://download.geofabrik.de/europe/netherlands-260815.osm.pbf
echo netherlands-260815.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260816.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260816.osm.pbf https://download.geofabrik.de/europe/luxembourg-260816.osm.pbf
echo luxembourg-260816.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/sea-20260815220000.zip" ] || wcurl -o $CACHE/sea-20260815220000.zip http://osm.thkukuk.de/data/sea-20260815220000.zip
echo sea-20260815220000.zip > names/sea
...
[ -f "$CACHE/327448-659347e519343.zip" ] || wcurl -o $CACHE/327448-659347e519343.zip http://download.geonames.org/export/dump/cities15000.zip
echo 327448-659347e519343.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
