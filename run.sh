...
[ -f "$CACHE/luxembourg-260609.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260609.osm.pbf https://download.geofabrik.de/europe/luxembourg-260609.osm.pbf
echo luxembourg-260609.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/3207b2-653dc34358b97.zip" ] || wcurl -o $CACHE/3207b2-653dc34358b97.zip http://download.geonames.org/export/dump/cities15000.zip
echo 3207b2-653dc34358b97.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
