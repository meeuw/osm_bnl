...
[ -f "$CACHE/belgium-260618.osm.pbf" ] || wcurl -o $CACHE/belgium-260618.osm.pbf https://download.geofabrik.de/europe/belgium-260618.osm.pbf
echo belgium-260618.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260618.osm.pbf" ] || wcurl -o $CACHE/netherlands-260618.osm.pbf https://download.geofabrik.de/europe/netherlands-260618.osm.pbf
echo netherlands-260618.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260618.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260618.osm.pbf https://download.geofabrik.de/europe/luxembourg-260618.osm.pbf
echo luxembourg-260618.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/3217f6-654914a89f756.zip" ] || wcurl -o $CACHE/3217f6-654914a89f756.zip http://download.geonames.org/export/dump/cities15000.zip
echo 3217f6-654914a89f756.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
