...
[ -f "$CACHE/belgium-260331.osm.pbf" ] || wcurl -o $CACHE/belgium-260331.osm.pbf https://download.geofabrik.de/europe/belgium-260331.osm.pbf
echo belgium-260331.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260331.osm.pbf" ] || wcurl -o $CACHE/netherlands-260331.osm.pbf https://download.geofabrik.de/europe/netherlands-260331.osm.pbf
echo netherlands-260331.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260401.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260401.osm.pbf https://download.geofabrik.de/europe/luxembourg-260401.osm.pbf
echo luxembourg-260401.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/sea-20260331220000.zip" ] || wcurl -o $CACHE/sea-20260331220000.zip http://osm.thkukuk.de/data/sea-20260331220000.zip
echo sea-20260331220000.zip > names/sea
...
[ -f "$CACHE/2efaaf-64e703191f806.zip" ] || wcurl -o $CACHE/2efaaf-64e703191f806.zip http://download.geonames.org/export/dump/cities15000.zip
echo 2efaaf-64e703191f806.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
