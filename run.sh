...
[ -f "$CACHE/belgium-260629.osm.pbf" ] || wcurl -o $CACHE/belgium-260629.osm.pbf https://download.geofabrik.de/europe/belgium-260629.osm.pbf
echo belgium-260629.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260629.osm.pbf" ] || wcurl -o $CACHE/netherlands-260629.osm.pbf https://download.geofabrik.de/europe/netherlands-260629.osm.pbf
echo netherlands-260629.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260629.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260629.osm.pbf https://download.geofabrik.de/europe/luxembourg-260629.osm.pbf
echo luxembourg-260629.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/32285c-6556e8c34a534.zip" ] || wcurl -o $CACHE/32285c-6556e8c34a534.zip http://download.geonames.org/export/dump/cities15000.zip
echo 32285c-6556e8c34a534.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
