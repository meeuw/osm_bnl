...
[ -f "$CACHE/belgium-260828.osm.pbf" ] || wcurl -o $CACHE/belgium-260828.osm.pbf https://download.geofabrik.de/europe/belgium-260828.osm.pbf
echo belgium-260828.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260828.osm.pbf" ] || wcurl -o $CACHE/netherlands-260828.osm.pbf https://download.geofabrik.de/europe/netherlands-260828.osm.pbf
echo netherlands-260828.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260828.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260828.osm.pbf https://download.geofabrik.de/europe/luxembourg-260828.osm.pbf
echo luxembourg-260828.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/sea-20260827220000.zip" ] || wcurl -o $CACHE/sea-20260827220000.zip http://osm.thkukuk.de/data/sea-20260827220000.zip
echo sea-20260827220000.zip > names/sea
...
[ -f "$CACHE/328314-65a25d64b67fd.zip" ] || wcurl -o $CACHE/328314-65a25d64b67fd.zip http://download.geonames.org/export/dump/cities15000.zip
echo 328314-65a25d64b67fd.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
