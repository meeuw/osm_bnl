...
[ -f "$CACHE/belgium-260303.osm.pbf" ] || wcurl -o $CACHE/belgium-260303.osm.pbf https://download.geofabrik.de/europe/belgium-260303.osm.pbf
echo belgium-260303.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260303.osm.pbf" ] || wcurl -o $CACHE/netherlands-260303.osm.pbf https://download.geofabrik.de/europe/netherlands-260303.osm.pbf
echo netherlands-260303.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260303.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260303.osm.pbf https://download.geofabrik.de/europe/luxembourg-260303.osm.pbf
echo luxembourg-260303.osm.pbf > names/geofabrik-luxembourg
[ -f "$CACHE/bounds-20260227.zip" ] || wcurl -o $CACHE/bounds-20260227.zip http://osm.thkukuk.de/data/bounds-20260227.zip
echo bounds-20260227.zip > names/bounds
[ -f "$CACHE/sea-20260302230000.zip" ] || wcurl -o $CACHE/sea-20260302230000.zip http://osm.thkukuk.de/data/sea-20260302230000.zip
echo sea-20260302230000.zip > names/sea
...
[ -f "$CACHE/2ec879-64c29bd25a3ce.zip" ] || wcurl -o $CACHE/2ec879-64c29bd25a3ce.zip http://download.geonames.org/export/dump/cities15000.zip
echo 2ec879-64c29bd25a3ce.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
