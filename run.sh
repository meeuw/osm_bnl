...
[ -f "$CACHE/belgium-260419.osm.pbf" ] || wcurl -o $CACHE/belgium-260419.osm.pbf https://download.geofabrik.de/europe/belgium-260419.osm.pbf
echo belgium-260419.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260419.osm.pbf" ] || wcurl -o $CACHE/netherlands-260419.osm.pbf https://download.geofabrik.de/europe/netherlands-260419.osm.pbf
echo netherlands-260419.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260419.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260419.osm.pbf https://download.geofabrik.de/europe/luxembourg-260419.osm.pbf
echo luxembourg-260419.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/31b999-64fda63cd8401.zip" ] || wcurl -o $CACHE/31b999-64fda63cd8401.zip http://download.geonames.org/export/dump/cities15000.zip
echo 31b999-64fda63cd8401.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
