...
[ -f "$CACHE/belgium-260906.osm.pbf" ] || wcurl -o $CACHE/belgium-260906.osm.pbf https://download.geofabrik.de/europe/belgium-260906.osm.pbf
echo belgium-260906.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260906.osm.pbf" ] || wcurl -o $CACHE/netherlands-260906.osm.pbf https://download.geofabrik.de/europe/netherlands-260906.osm.pbf
echo netherlands-260906.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260906.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260906.osm.pbf https://download.geofabrik.de/europe/luxembourg-260906.osm.pbf
echo luxembourg-260906.osm.pbf > names/geofabrik-luxembourg
[ -f "$CACHE/bounds-20260904.zip" ] || wcurl -o $CACHE/bounds-20260904.zip http://osm.thkukuk.de/data/bounds-20260904.zip
echo bounds-20260904.zip > names/bounds
[ -f "$CACHE/sea-20260905220000.zip" ] || wcurl -o $CACHE/sea-20260905220000.zip http://osm.thkukuk.de/data/sea-20260905220000.zip
echo sea-20260905220000.zip > names/sea
...
[ -f "$CACHE/329686-65adae1542364.zip" ] || wcurl -o $CACHE/329686-65adae1542364.zip http://download.geonames.org/export/dump/cities15000.zip
echo 329686-65adae1542364.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
