...
[ -f "$CACHE/belgium-260720.osm.pbf" ] || wcurl -o $CACHE/belgium-260720.osm.pbf https://download.geofabrik.de/europe/belgium-260720.osm.pbf
echo belgium-260720.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260720.osm.pbf" ] || wcurl -o $CACHE/netherlands-260720.osm.pbf https://download.geofabrik.de/europe/netherlands-260720.osm.pbf
echo netherlands-260720.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260720.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260720.osm.pbf https://download.geofabrik.de/europe/luxembourg-260720.osm.pbf
echo luxembourg-260720.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/325dcb-6571500757102.zip" ] || wcurl -o $CACHE/325dcb-6571500757102.zip http://download.geonames.org/export/dump/cities15000.zip
echo 325dcb-6571500757102.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
