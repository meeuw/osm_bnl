...
[ -f "$CACHE/belgium-260623.osm.pbf" ] || wcurl -o $CACHE/belgium-260623.osm.pbf https://download.geofabrik.de/europe/belgium-260623.osm.pbf
echo belgium-260623.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260623.osm.pbf" ] || wcurl -o $CACHE/netherlands-260623.osm.pbf https://download.geofabrik.de/europe/netherlands-260623.osm.pbf
echo netherlands-260623.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260623.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260623.osm.pbf https://download.geofabrik.de/europe/luxembourg-260623.osm.pbf
echo luxembourg-260623.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/322040-654f5d87639c7.zip" ] || wcurl -o $CACHE/322040-654f5d87639c7.zip http://download.geonames.org/export/dump/cities15000.zip
echo 322040-654f5d87639c7.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
