...
[ -f "$CACHE/belgium-260612.osm.pbf" ] || wcurl -o $CACHE/belgium-260612.osm.pbf https://download.geofabrik.de/europe/belgium-260612.osm.pbf
echo belgium-260612.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260612.osm.pbf" ] || wcurl -o $CACHE/netherlands-260612.osm.pbf https://download.geofabrik.de/europe/netherlands-260612.osm.pbf
echo netherlands-260612.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260612.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260612.osm.pbf https://download.geofabrik.de/europe/luxembourg-260612.osm.pbf
echo luxembourg-260612.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/320da7-654189bedc533.zip" ] || wcurl -o $CACHE/320da7-654189bedc533.zip http://download.geonames.org/export/dump/cities15000.zip
echo 320da7-654189bedc533.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
