...
[ -f "$CACHE/belgium-260424.osm.pbf" ] || wcurl -o $CACHE/belgium-260424.osm.pbf https://download.geofabrik.de/europe/belgium-260424.osm.pbf
echo belgium-260424.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260424.osm.pbf" ] || wcurl -o $CACHE/netherlands-260424.osm.pbf https://download.geofabrik.de/europe/netherlands-260424.osm.pbf
echo netherlands-260424.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260424.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260424.osm.pbf https://download.geofabrik.de/europe/luxembourg-260424.osm.pbf
echo luxembourg-260424.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/sea-20260422220000.zip" ] || wcurl -o $CACHE/sea-20260422220000.zip http://osm.thkukuk.de/data/sea-20260422220000.zip
echo sea-20260422220000.zip > names/sea
...
[ -f "$CACHE/31c48f-6503ef61d3063.zip" ] || wcurl -o $CACHE/31c48f-6503ef61d3063.zip http://download.geonames.org/export/dump/cities15000.zip
echo 31c48f-6503ef61d3063.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
