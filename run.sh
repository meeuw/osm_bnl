...
[ -f "$CACHE/belgium-260614.osm.pbf" ] || wcurl -o $CACHE/belgium-260614.osm.pbf https://download.geofabrik.de/europe/belgium-260614.osm.pbf
echo belgium-260614.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260614.osm.pbf" ] || wcurl -o $CACHE/netherlands-260614.osm.pbf https://download.geofabrik.de/europe/netherlands-260614.osm.pbf
echo netherlands-260614.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260614.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260614.osm.pbf https://download.geofabrik.de/europe/luxembourg-260614.osm.pbf
echo luxembourg-260614.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/32103f-65440c96bf489.zip" ] || wcurl -o $CACHE/32103f-65440c96bf489.zip http://download.geonames.org/export/dump/cities15000.zip
echo 32103f-65440c96bf489.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
