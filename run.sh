...
[ -f "$CACHE/belgium-260726.osm.pbf" ] || wcurl -o $CACHE/belgium-260726.osm.pbf https://download.geofabrik.de/europe/belgium-260726.osm.pbf
echo belgium-260726.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260726.osm.pbf" ] || wcurl -o $CACHE/netherlands-260726.osm.pbf https://download.geofabrik.de/europe/netherlands-260726.osm.pbf
echo netherlands-260726.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260726.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260726.osm.pbf https://download.geofabrik.de/europe/luxembourg-260726.osm.pbf
echo luxembourg-260726.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/sea-20260726220000.zip" ] || wcurl -o $CACHE/sea-20260726220000.zip http://osm.thkukuk.de/data/sea-20260726220000.zip
echo sea-20260726220000.zip > names/sea
...
[ -f "$CACHE/3263d0-657a1c83e74ae.zip" ] || wcurl -o $CACHE/3263d0-657a1c83e74ae.zip http://download.geonames.org/export/dump/cities15000.zip
echo 3263d0-657a1c83e74ae.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
