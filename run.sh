...
[ -f "$CACHE/belgium-260607.osm.pbf" ] || wcurl -o $CACHE/belgium-260607.osm.pbf https://download.geofabrik.de/europe/belgium-260607.osm.pbf
echo belgium-260607.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260607.osm.pbf" ] || wcurl -o $CACHE/netherlands-260607.osm.pbf https://download.geofabrik.de/europe/netherlands-260607.osm.pbf
echo netherlands-260607.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260607.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260607.osm.pbf https://download.geofabrik.de/europe/luxembourg-260607.osm.pbf
echo luxembourg-260607.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/320118-653b3fbdc800d.zip" ] || wcurl -o $CACHE/320118-653b3fbdc800d.zip http://download.geonames.org/export/dump/cities15000.zip
echo 320118-653b3fbdc800d.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
