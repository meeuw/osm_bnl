...
[ -f "$CACHE/sea-20260831220000.zip" ] || wcurl -o $CACHE/sea-20260831220000.zip http://osm.thkukuk.de/data/sea-20260831220000.zip
echo sea-20260831220000.zip > names/sea
...
[ -f "$CACHE/328cea-65a765cb279af.zip" ] || wcurl -o $CACHE/328cea-65a765cb279af.zip http://download.geonames.org/export/dump/cities15000.zip
echo 328cea-65a765cb279af.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
