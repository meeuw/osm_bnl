...
[ -f "$CACHE/belgium-260830.osm.pbf" ] || wcurl -o $CACHE/belgium-260830.osm.pbf https://download.geofabrik.de/europe/belgium-260830.osm.pbf
echo belgium-260830.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260830.osm.pbf" ] || wcurl -o $CACHE/netherlands-260830.osm.pbf https://download.geofabrik.de/europe/netherlands-260830.osm.pbf
echo netherlands-260830.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260830.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260830.osm.pbf https://download.geofabrik.de/europe/luxembourg-260830.osm.pbf
echo luxembourg-260830.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/sea-20260829220000.zip" ] || wcurl -o $CACHE/sea-20260829220000.zip http://osm.thkukuk.de/data/sea-20260829220000.zip
echo sea-20260829220000.zip > names/sea
...
[ -f "$CACHE/328a9c-65a4e1827bf11.zip" ] || wcurl -o $CACHE/328a9c-65a4e1827bf11.zip http://download.geonames.org/export/dump/cities15000.zip
echo 328a9c-65a4e1827bf11.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
