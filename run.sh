...
[ -f "$CACHE/belgium-260520.osm.pbf" ] || wcurl -o $CACHE/belgium-260520.osm.pbf https://download.geofabrik.de/europe/belgium-260520.osm.pbf
echo belgium-260520.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260520.osm.pbf" ] || wcurl -o $CACHE/netherlands-260520.osm.pbf https://download.geofabrik.de/europe/netherlands-260520.osm.pbf
echo netherlands-260520.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260520.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260520.osm.pbf https://download.geofabrik.de/europe/luxembourg-260520.osm.pbf
echo luxembourg-260520.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/31ef4b-65249edd71768.zip" ] || wcurl -o $CACHE/31ef4b-65249edd71768.zip http://download.geonames.org/export/dump/cities15000.zip
echo 31ef4b-65249edd71768.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
