...
[ -f "$CACHE/32722d-658f850d07784.zip" ] || wcurl -o $CACHE/32722d-658f850d07784.zip http://download.geonames.org/export/dump/cities15000.zip
echo 32722d-658f850d07784.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
