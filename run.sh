...
[ -f "$CACHE/belgium-260524.osm.pbf" ] || wcurl -o $CACHE/belgium-260524.osm.pbf https://download.geofabrik.de/europe/belgium-260524.osm.pbf
echo belgium-260524.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260524.osm.pbf" ] || wcurl -o $CACHE/netherlands-260524.osm.pbf https://download.geofabrik.de/europe/netherlands-260524.osm.pbf
echo netherlands-260524.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260524.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260524.osm.pbf https://download.geofabrik.de/europe/luxembourg-260524.osm.pbf
echo luxembourg-260524.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/31f6cb-6529a5ad52494.zip" ] || wcurl -o $CACHE/31f6cb-6529a5ad52494.zip http://download.geonames.org/export/dump/cities15000.zip
echo 31f6cb-6529a5ad52494.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
