...
[ -f "$CACHE/luxembourg-260404.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260404.osm.pbf https://download.geofabrik.de/europe/luxembourg-260404.osm.pbf
echo luxembourg-260404.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/sea-20260403220000.zip" ] || wcurl -o $CACHE/sea-20260403220000.zip http://osm.thkukuk.de/data/sea-20260403220000.zip
echo sea-20260403220000.zip > names/sea
...
[ -f "$CACHE/2efbcb-64eacfeaec37e.zip" ] || wcurl -o $CACHE/2efbcb-64eacfeaec37e.zip http://download.geonames.org/export/dump/cities15000.zip
echo 2efbcb-64eacfeaec37e.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
