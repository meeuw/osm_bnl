...
[ -f "$CACHE/belgium-260806.osm.pbf" ] || wcurl -o $CACHE/belgium-260806.osm.pbf https://download.geofabrik.de/europe/belgium-260806.osm.pbf
echo belgium-260806.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260806.osm.pbf" ] || wcurl -o $CACHE/netherlands-260806.osm.pbf https://download.geofabrik.de/europe/netherlands-260806.osm.pbf
...
[ -f "$CACHE/sea-20260808220000.zip" ] || wcurl -o $CACHE/sea-20260808220000.zip http://osm.thkukuk.de/data/sea-20260808220000.zip
echo sea-20260808220000.zip > names/sea
...
[ -f "$CACHE/326f52-658a7c9243406.zip" ] || wcurl -o $CACHE/326f52-658a7c9243406.zip http://download.geonames.org/export/dump/cities15000.zip
echo 326f52-658a7c9243406.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
