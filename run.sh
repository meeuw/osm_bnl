...
[ -f "$CACHE/3212ee-6546908e9f2f0.zip" ] || wcurl -o $CACHE/3212ee-6546908e9f2f0.zip http://download.geonames.org/export/dump/cities15000.zip
echo 3212ee-6546908e9f2f0.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
