...
[ -f "$CACHE/belgium-260423.osm.pbf" ] || wcurl -o $CACHE/belgium-260423.osm.pbf https://download.geofabrik.de/europe/belgium-260423.osm.pbf
echo belgium-260423.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260423.osm.pbf" ] || wcurl -o $CACHE/netherlands-260423.osm.pbf https://download.geofabrik.de/europe/netherlands-260423.osm.pbf
echo netherlands-260423.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260423.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260423.osm.pbf https://download.geofabrik.de/europe/luxembourg-260423.osm.pbf
echo luxembourg-260423.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/31c481-6502ab7b11c97.zip" ] || wcurl -o $CACHE/31c481-6502ab7b11c97.zip http://download.geonames.org/export/dump/cities15000.zip
echo 31c481-6502ab7b11c97.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
