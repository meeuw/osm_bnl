...
[ -f "$CACHE/belgium-260728.osm.pbf" ] || wcurl -o $CACHE/belgium-260728.osm.pbf https://download.geofabrik.de/europe/belgium-260728.osm.pbf
echo belgium-260728.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260728.osm.pbf" ] || wcurl -o $CACHE/netherlands-260728.osm.pbf https://download.geofabrik.de/europe/netherlands-260728.osm.pbf
echo netherlands-260728.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260728.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260728.osm.pbf https://download.geofabrik.de/europe/luxembourg-260728.osm.pbf
echo luxembourg-260728.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/326432-657b5e2ce0fbf.zip" ] || wcurl -o $CACHE/326432-657b5e2ce0fbf.zip http://download.geonames.org/export/dump/cities15000.zip
echo 326432-657b5e2ce0fbf.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
