...
[ -f "$CACHE/sea-20260915220000.zip" ] || wcurl -o $CACHE/sea-20260915220000.zip http://osm.thkukuk.de/data/sea-20260915220000.zip
echo sea-20260915220000.zip > names/sea
...
[ -f "$CACHE/332e1a-65ba516738ef1.zip" ] || wcurl -o $CACHE/332e1a-65ba516738ef1.zip http://download.geonames.org/export/dump/cities15000.zip
echo 332e1a-65ba516738ef1.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
