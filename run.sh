...
[ -f "$CACHE/belgium-260530.osm.pbf" ] || wcurl -o $CACHE/belgium-260530.osm.pbf https://download.geofabrik.de/europe/belgium-260530.osm.pbf
echo belgium-260530.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260530.osm.pbf" ] || wcurl -o $CACHE/netherlands-260530.osm.pbf https://download.geofabrik.de/europe/netherlands-260530.osm.pbf
echo netherlands-260530.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260530.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260530.osm.pbf https://download.geofabrik.de/europe/luxembourg-260530.osm.pbf
echo luxembourg-260530.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/31f8bf-6531391625d54.zip" ] || wcurl -o $CACHE/31f8bf-6531391625d54.zip http://download.geonames.org/export/dump/cities15000.zip
echo 31f8bf-6531391625d54.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
