...
[ -f "$CACHE/belgium-260523.osm.pbf" ] || wcurl -o $CACHE/belgium-260523.osm.pbf https://download.geofabrik.de/europe/belgium-260523.osm.pbf
echo belgium-260523.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260523.osm.pbf" ] || wcurl -o $CACHE/netherlands-260523.osm.pbf https://download.geofabrik.de/europe/netherlands-260523.osm.pbf
echo netherlands-260523.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260523.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260523.osm.pbf https://download.geofabrik.de/europe/luxembourg-260523.osm.pbf
echo luxembourg-260523.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/31f6a5-65286be64c7e2.zip" ] || wcurl -o $CACHE/31f6a5-65286be64c7e2.zip http://download.geonames.org/export/dump/cities15000.zip
echo 31f6a5-65286be64c7e2.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
