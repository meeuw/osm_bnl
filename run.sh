...
[ -f "$CACHE/belgium-260619.osm.pbf" ] || wcurl -o $CACHE/belgium-260619.osm.pbf https://download.geofabrik.de/europe/belgium-260619.osm.pbf
echo belgium-260619.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260619.osm.pbf" ] || wcurl -o $CACHE/netherlands-260619.osm.pbf https://download.geofabrik.de/europe/netherlands-260619.osm.pbf
echo netherlands-260619.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260619.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260619.osm.pbf https://download.geofabrik.de/europe/luxembourg-260619.osm.pbf
echo luxembourg-260619.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/321889-654a5657cfd64.zip" ] || wcurl -o $CACHE/321889-654a5657cfd64.zip http://download.geonames.org/export/dump/cities15000.zip
echo 321889-654a5657cfd64.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
