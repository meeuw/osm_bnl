...
[ -f "$CACHE/belgium-260611.osm.pbf" ] || wcurl -o $CACHE/belgium-260611.osm.pbf https://download.geofabrik.de/europe/belgium-260611.osm.pbf
echo belgium-260611.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260611.osm.pbf" ] || wcurl -o $CACHE/netherlands-260611.osm.pbf https://download.geofabrik.de/europe/netherlands-260611.osm.pbf
echo netherlands-260611.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260611.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260611.osm.pbf https://download.geofabrik.de/europe/luxembourg-260611.osm.pbf
echo luxembourg-260611.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/320bca-654046f9cf8d7.zip" ] || wcurl -o $CACHE/320bca-654046f9cf8d7.zip http://download.geonames.org/export/dump/cities15000.zip
echo 320bca-654046f9cf8d7.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
