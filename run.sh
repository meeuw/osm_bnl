...
[ -f "$CACHE/belgium-260505.osm.pbf" ] || wcurl -o $CACHE/belgium-260505.osm.pbf https://download.geofabrik.de/europe/belgium-260505.osm.pbf
echo belgium-260505.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260505.osm.pbf" ] || wcurl -o $CACHE/netherlands-260505.osm.pbf https://download.geofabrik.de/europe/netherlands-260505.osm.pbf
echo netherlands-260505.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260505.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260505.osm.pbf https://download.geofabrik.de/europe/luxembourg-260505.osm.pbf
echo luxembourg-260505.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/31d510-6511c70667884.zip" ] || wcurl -o $CACHE/31d510-6511c70667884.zip http://download.geonames.org/export/dump/cities15000.zip
echo 31d510-6511c70667884.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
