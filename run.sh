...
[ -f "$CACHE/belgium-260322.osm.pbf" ] || wcurl -o $CACHE/belgium-260322.osm.pbf https://download.geofabrik.de/europe/belgium-260322.osm.pbf
echo belgium-260322.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260322.osm.pbf" ] || wcurl -o $CACHE/netherlands-260322.osm.pbf https://download.geofabrik.de/europe/netherlands-260322.osm.pbf
echo netherlands-260322.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260322.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260322.osm.pbf https://download.geofabrik.de/europe/luxembourg-260322.osm.pbf
echo luxembourg-260322.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/sea-20260321230000.zip" ] || wcurl -o $CACHE/sea-20260321230000.zip http://osm.thkukuk.de/data/sea-20260321230000.zip
echo sea-20260321230000.zip > names/sea
...
[ -f "$CACHE/2edd71-64da7e0ef0c4e.zip" ] || wcurl -o $CACHE/2edd71-64da7e0ef0c4e.zip http://download.geonames.org/export/dump/cities15000.zip
echo 2edd71-64da7e0ef0c4e.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
