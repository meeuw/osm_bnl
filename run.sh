...
[ -f "$CACHE/belgium-260916.osm.pbf" ] || wcurl -o $CACHE/belgium-260916.osm.pbf https://download.geofabrik.de/europe/belgium-260916.osm.pbf
echo belgium-260916.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260916.osm.pbf" ] || wcurl -o $CACHE/netherlands-260916.osm.pbf https://download.geofabrik.de/europe/netherlands-260916.osm.pbf
echo netherlands-260916.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260916.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260916.osm.pbf https://download.geofabrik.de/europe/luxembourg-260916.osm.pbf
echo luxembourg-260916.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/sea-20260916220000.zip" ] || wcurl -o $CACHE/sea-20260916220000.zip http://osm.thkukuk.de/data/sea-20260916220000.zip
echo sea-20260916220000.zip > names/sea
...
[ -f "$CACHE/332e1d-65bb837c691ab.zip" ] || wcurl -o $CACHE/332e1d-65bb837c691ab.zip http://download.geonames.org/export/dump/cities15000.zip
echo 332e1d-65bb837c691ab.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
