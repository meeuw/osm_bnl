...
[ -f "$CACHE/belgium-260703.osm.pbf" ] || wcurl -o $CACHE/belgium-260703.osm.pbf https://download.geofabrik.de/europe/belgium-260703.osm.pbf
echo belgium-260703.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260703.osm.pbf" ] || wcurl -o $CACHE/netherlands-260703.osm.pbf https://download.geofabrik.de/europe/netherlands-260703.osm.pbf
echo netherlands-260703.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260703.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260703.osm.pbf https://download.geofabrik.de/europe/luxembourg-260703.osm.pbf
echo luxembourg-260703.osm.pbf > names/geofabrik-luxembourg
