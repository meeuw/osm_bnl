...
[ -f "$CACHE/luxembourg-260323.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260323.osm.pbf https://download.geofabrik.de/europe/luxembourg-260323.osm.pbf
echo luxembourg-260323.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/sea-20260322230000.zip" ] || wcurl -o $CACHE/sea-20260322230000.zip http://osm.thkukuk.de/data/sea-20260322230000.zip
echo sea-20260322230000.zip > names/sea
...
[ -f "$CACHE/2ee012-64dbc036e1168.zip" ] || wcurl -o $CACHE/2ee012-64dbc036e1168.zip http://download.geonames.org/export/dump/cities15000.zip
echo 2ee012-64dbc036e1168.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
