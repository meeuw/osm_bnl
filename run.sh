...
[ -f "$CACHE/belgium-260705.osm.pbf" ] || wcurl -o $CACHE/belgium-260705.osm.pbf https://download.geofabrik.de/europe/belgium-260705.osm.pbf
echo belgium-260705.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260705.osm.pbf" ] || wcurl -o $CACHE/netherlands-260705.osm.pbf https://download.geofabrik.de/europe/netherlands-260705.osm.pbf
echo netherlands-260705.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260705.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260705.osm.pbf https://download.geofabrik.de/europe/luxembourg-260705.osm.pbf
echo luxembourg-260705.osm.pbf > names/geofabrik-luxembourg
[ -f "$CACHE/bounds-20260703.zip" ] || wcurl -o $CACHE/bounds-20260703.zip http://osm.thkukuk.de/data/bounds-20260703.zip
echo bounds-20260703.zip > names/bounds
[ -f "$CACHE/sea-20260703000000.zip" ] || wcurl -o $CACHE/sea-20260703000000.zip http://osm.thkukuk.de/data/sea-20260703000000.zip
echo sea-20260703000000.zip > names/sea
...
[ -f "$CACHE/322fbd-655e73c3c22f3.zip" ] || wcurl -o $CACHE/322fbd-655e73c3c22f3.zip http://download.geonames.org/export/dump/cities15000.zip
echo 322fbd-655e73c3c22f3.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
