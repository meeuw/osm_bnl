...
[ -f "$CACHE/belgium-260704.osm.pbf" ] || wcurl -o $CACHE/belgium-260704.osm.pbf https://download.geofabrik.de/europe/belgium-260704.osm.pbf
echo belgium-260704.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260704.osm.pbf" ] || wcurl -o $CACHE/netherlands-260704.osm.pbf https://download.geofabrik.de/europe/netherlands-260704.osm.pbf
echo netherlands-260704.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260704.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260704.osm.pbf https://download.geofabrik.de/europe/luxembourg-260704.osm.pbf
echo luxembourg-260704.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/322f70-655bf04bb8034.zip" ] || wcurl -o $CACHE/322f70-655bf04bb8034.zip http://download.geonames.org/export/dump/cities15000.zip
echo 322f70-655bf04bb8034.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
