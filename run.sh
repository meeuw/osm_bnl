...
[ -f "$CACHE/31e910-651e69c4ab735.zip" ] || wcurl -o $CACHE/31e910-651e69c4ab735.zip http://download.geonames.org/export/dump/cities15000.zip
echo 31e910-651e69c4ab735.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
