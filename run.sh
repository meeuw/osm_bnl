...
[ -f "$CACHE/belgium-260620.osm.pbf" ] || wcurl -o $CACHE/belgium-260620.osm.pbf https://download.geofabrik.de/europe/belgium-260620.osm.pbf
echo belgium-260620.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260620.osm.pbf" ] || wcurl -o $CACHE/netherlands-260620.osm.pbf https://download.geofabrik.de/europe/netherlands-260620.osm.pbf
echo netherlands-260620.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260620.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260620.osm.pbf https://download.geofabrik.de/europe/luxembourg-260620.osm.pbf
echo luxembourg-260620.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/321bc1-654ba0d69707a.zip" ] || wcurl -o $CACHE/321bc1-654ba0d69707a.zip http://download.geonames.org/export/dump/cities15000.zip
echo 321bc1-654ba0d69707a.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
