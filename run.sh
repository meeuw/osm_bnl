...
[ -f "$CACHE/belgium-260415.osm.pbf" ] || wcurl -o $CACHE/belgium-260415.osm.pbf https://download.geofabrik.de/europe/belgium-260415.osm.pbf
echo belgium-260415.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260415.osm.pbf" ] || wcurl -o $CACHE/netherlands-260415.osm.pbf https://download.geofabrik.de/europe/netherlands-260415.osm.pbf
echo netherlands-260415.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260415.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260415.osm.pbf https://download.geofabrik.de/europe/luxembourg-260415.osm.pbf
echo luxembourg-260415.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/315484-64f89ce0555ed.zip" ] || wcurl -o $CACHE/315484-64f89ce0555ed.zip http://download.geonames.org/export/dump/cities15000.zip
echo 315484-64f89ce0555ed.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
