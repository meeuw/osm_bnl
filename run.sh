...
[ -f "$CACHE/belgium-260526.osm.pbf" ] || wcurl -o $CACHE/belgium-260526.osm.pbf https://download.geofabrik.de/europe/belgium-260526.osm.pbf
echo belgium-260526.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260526.osm.pbf" ] || wcurl -o $CACHE/netherlands-260526.osm.pbf https://download.geofabrik.de/europe/netherlands-260526.osm.pbf
echo netherlands-260526.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260526.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260526.osm.pbf https://download.geofabrik.de/europe/luxembourg-260526.osm.pbf
echo luxembourg-260526.osm.pbf > names/geofabrik-luxembourg
[ -f "$CACHE/bounds-20260522.zip" ] || wcurl -o $CACHE/bounds-20260522.zip http://osm.thkukuk.de/data/bounds-20260522.zip
echo bounds-20260522.zip > names/bounds
...
[ -f "$CACHE/31f6e1-652c2a84b57fc.zip" ] || wcurl -o $CACHE/31f6e1-652c2a84b57fc.zip http://download.geonames.org/export/dump/cities15000.zip
echo 31f6e1-652c2a84b57fc.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
