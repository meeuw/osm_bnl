...
[ -f "$CACHE/belgium-260313.osm.pbf" ] || wcurl -o $CACHE/belgium-260313.osm.pbf https://download.geofabrik.de/europe/belgium-260313.osm.pbf
echo belgium-260313.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260313.osm.pbf" ] || wcurl -o $CACHE/netherlands-260313.osm.pbf https://download.geofabrik.de/europe/netherlands-260313.osm.pbf
echo netherlands-260313.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260314.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260314.osm.pbf https://download.geofabrik.de/europe/luxembourg-260314.osm.pbf
echo luxembourg-260314.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/sea-20260313230000.zip" ] || wcurl -o $CACHE/sea-20260313230000.zip http://osm.thkukuk.de/data/sea-20260313230000.zip
echo sea-20260313230000.zip > names/sea
...
[ -f "$CACHE/2ed425-64d0760fbd258.zip" ] || wcurl -o $CACHE/2ed425-64d0760fbd258.zip http://download.geonames.org/export/dump/cities15000.zip
echo 2ed425-64d0760fbd258.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
