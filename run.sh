...
[ -f "$CACHE/belgium-260521.osm.pbf" ] || wcurl -o $CACHE/belgium-260521.osm.pbf https://download.geofabrik.de/europe/belgium-260521.osm.pbf
echo belgium-260521.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260521.osm.pbf" ] || wcurl -o $CACHE/netherlands-260521.osm.pbf https://download.geofabrik.de/europe/netherlands-260521.osm.pbf
echo netherlands-260521.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260521.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260521.osm.pbf https://download.geofabrik.de/europe/luxembourg-260521.osm.pbf
echo luxembourg-260521.osm.pbf > names/geofabrik-luxembourg
[ -f "$CACHE/bounds-20260515.zip" ] || wcurl -o $CACHE/bounds-20260515.zip http://osm.thkukuk.de/data/bounds-20260515.zip
echo bounds-20260515.zip > names/bounds
...
[ -f "$CACHE/31f43a-6525e06a8a825.zip" ] || wcurl -o $CACHE/31f43a-6525e06a8a825.zip http://download.geonames.org/export/dump/cities15000.zip
echo 31f43a-6525e06a8a825.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
