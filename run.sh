...
[ -f "$CACHE/luxembourg-260326.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260326.osm.pbf https://download.geofabrik.de/europe/luxembourg-260326.osm.pbf
echo luxembourg-260326.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/2ee360-64df85bb5def2.zip" ] || wcurl -o $CACHE/2ee360-64df85bb5def2.zip http://download.geonames.org/export/dump/cities15000.zip
echo 2ee360-64df85bb5def2.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
