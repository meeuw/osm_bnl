...
[ -f "$CACHE/belgium-260528.osm.pbf" ] || wcurl -o $CACHE/belgium-260528.osm.pbf https://download.geofabrik.de/europe/belgium-260528.osm.pbf
echo belgium-260528.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260528.osm.pbf" ] || wcurl -o $CACHE/netherlands-260528.osm.pbf https://download.geofabrik.de/europe/netherlands-260528.osm.pbf
echo netherlands-260528.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260528.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260528.osm.pbf https://download.geofabrik.de/europe/luxembourg-260528.osm.pbf
echo luxembourg-260528.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/31f729-652ead949c83d.zip" ] || wcurl -o $CACHE/31f729-652ead949c83d.zip http://download.geonames.org/export/dump/cities15000.zip
echo 31f729-652ead949c83d.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
