...
[ -f "$CACHE/belgium-260811.osm.pbf" ] || wcurl -o $CACHE/belgium-260811.osm.pbf https://download.geofabrik.de/europe/belgium-260811.osm.pbf
echo belgium-260811.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260811.osm.pbf" ] || wcurl -o $CACHE/netherlands-260811.osm.pbf https://download.geofabrik.de/europe/netherlands-260811.osm.pbf
echo netherlands-260811.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260811.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260811.osm.pbf https://download.geofabrik.de/europe/luxembourg-260811.osm.pbf
echo luxembourg-260811.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/327152-658d00dc66457.zip" ] || wcurl -o $CACHE/327152-658d00dc66457.zip http://download.geonames.org/export/dump/cities15000.zip
echo 327152-658d00dc66457.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
