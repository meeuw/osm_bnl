...
[ -f "$CACHE/belgium-260730.osm.pbf" ] || wcurl -o $CACHE/belgium-260730.osm.pbf https://download.geofabrik.de/europe/belgium-260730.osm.pbf
echo belgium-260730.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260731.osm.pbf" ] || wcurl -o $CACHE/netherlands-260731.osm.pbf https://download.geofabrik.de/europe/netherlands-260731.osm.pbf
echo netherlands-260731.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260731.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260731.osm.pbf https://download.geofabrik.de/europe/luxembourg-260731.osm.pbf
echo luxembourg-260731.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/32698e-657f24c2a9f7a.zip" ] || wcurl -o $CACHE/32698e-657f24c2a9f7a.zip http://download.geonames.org/export/dump/cities15000.zip
echo 32698e-657f24c2a9f7a.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
