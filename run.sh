...
[ -f "$CACHE/belgium-260711.osm.pbf" ] || wcurl -o $CACHE/belgium-260711.osm.pbf https://download.geofabrik.de/europe/belgium-260711.osm.pbf
echo belgium-260711.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260711.osm.pbf" ] || wcurl -o $CACHE/netherlands-260711.osm.pbf https://download.geofabrik.de/europe/netherlands-260711.osm.pbf
echo netherlands-260711.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260711.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260711.osm.pbf https://download.geofabrik.de/europe/luxembourg-260711.osm.pbf
echo luxembourg-260711.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/325734-6566054eb4e33.zip" ] || wcurl -o $CACHE/325734-6566054eb4e33.zip http://download.geonames.org/export/dump/cities15000.zip
echo 325734-6566054eb4e33.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
