...
[ -f "$CACHE/belgium-260708.osm.pbf" ] || wcurl -o $CACHE/belgium-260708.osm.pbf https://download.geofabrik.de/europe/belgium-260708.osm.pbf
echo belgium-260708.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260708.osm.pbf" ] || wcurl -o $CACHE/netherlands-260708.osm.pbf https://download.geofabrik.de/europe/netherlands-260708.osm.pbf
echo netherlands-260708.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260708.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260708.osm.pbf https://download.geofabrik.de/europe/luxembourg-260708.osm.pbf
echo luxembourg-260708.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/sea-20260708100000.zip" ] || wcurl -o $CACHE/sea-20260708100000.zip http://osm.thkukuk.de/data/sea-20260708100000.zip
echo sea-20260708100000.zip > names/sea
...
[ -f "$CACHE/325665-65637afdb1ac1.zip" ] || wcurl -o $CACHE/325665-65637afdb1ac1.zip http://download.geonames.org/export/dump/cities15000.zip
echo 325665-65637afdb1ac1.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
