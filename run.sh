...
[ -f "$CACHE/belgium-260508.osm.pbf" ] || wcurl -o $CACHE/belgium-260508.osm.pbf https://download.geofabrik.de/europe/belgium-260508.osm.pbf
echo belgium-260508.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260508.osm.pbf" ] || wcurl -o $CACHE/netherlands-260508.osm.pbf https://download.geofabrik.de/europe/netherlands-260508.osm.pbf
echo netherlands-260508.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260508.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260508.osm.pbf https://download.geofabrik.de/europe/luxembourg-260508.osm.pbf
echo luxembourg-260508.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/31db66-651587b2d0363.zip" ] || wcurl -o $CACHE/31db66-651587b2d0363.zip http://download.geonames.org/export/dump/cities15000.zip
echo 31db66-651587b2d0363.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
