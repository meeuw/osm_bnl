...
[ -f "$CACHE/belgium-260510.osm.pbf" ] || wcurl -o $CACHE/belgium-260510.osm.pbf https://download.geofabrik.de/europe/belgium-260510.osm.pbf
echo belgium-260510.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260510.osm.pbf" ] || wcurl -o $CACHE/netherlands-260510.osm.pbf https://download.geofabrik.de/europe/netherlands-260510.osm.pbf
echo netherlands-260510.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260510.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260510.osm.pbf https://download.geofabrik.de/europe/luxembourg-260510.osm.pbf
echo luxembourg-260510.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/31dc75-65180b6a91bba.zip" ] || wcurl -o $CACHE/31dc75-65180b6a91bba.zip http://download.geonames.org/export/dump/cities15000.zip
echo 31dc75-65180b6a91bba.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
