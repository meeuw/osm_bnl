...
[ -f "$CACHE/belgium-260414.osm.pbf" ] || wcurl -o $CACHE/belgium-260414.osm.pbf https://download.geofabrik.de/europe/belgium-260414.osm.pbf
echo belgium-260414.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260414.osm.pbf" ] || wcurl -o $CACHE/netherlands-260414.osm.pbf https://download.geofabrik.de/europe/netherlands-260414.osm.pbf
echo netherlands-260414.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260414.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260414.osm.pbf https://download.geofabrik.de/europe/luxembourg-260414.osm.pbf
echo luxembourg-260414.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/3153d3-64f75accf60e9.zip" ] || wcurl -o $CACHE/3153d3-64f75accf60e9.zip http://download.geonames.org/export/dump/cities15000.zip
echo 3153d3-64f75accf60e9.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
