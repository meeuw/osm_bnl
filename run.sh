...
[ -f "$CACHE/luxembourg-260622.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260622.osm.pbf https://download.geofabrik.de/europe/luxembourg-260622.osm.pbf
echo luxembourg-260622.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/321ec6-654e2907eb382.zip" ] || wcurl -o $CACHE/321ec6-654e2907eb382.zip http://download.geonames.org/export/dump/cities15000.zip
echo 321ec6-654e2907eb382.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
