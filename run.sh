...
[ -f "$CACHE/belgium-260511.osm.pbf" ] || wcurl -o $CACHE/belgium-260511.osm.pbf https://download.geofabrik.de/europe/belgium-260511.osm.pbf
echo belgium-260511.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260511.osm.pbf" ] || wcurl -o $CACHE/netherlands-260511.osm.pbf https://download.geofabrik.de/europe/netherlands-260511.osm.pbf
echo netherlands-260511.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260511.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260511.osm.pbf https://download.geofabrik.de/europe/luxembourg-260511.osm.pbf
echo luxembourg-260511.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/31dd09-65194ffe699e0.zip" ] || wcurl -o $CACHE/31dd09-65194ffe699e0.zip http://download.geonames.org/export/dump/cities15000.zip
echo 31dd09-65194ffe699e0.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
