...
[ -f "$CACHE/belgium-260707.osm.pbf" ] || wcurl -o $CACHE/belgium-260707.osm.pbf https://download.geofabrik.de/europe/belgium-260707.osm.pbf
echo belgium-260707.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260707.osm.pbf" ] || wcurl -o $CACHE/netherlands-260707.osm.pbf https://download.geofabrik.de/europe/netherlands-260707.osm.pbf
echo netherlands-260707.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260707.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260707.osm.pbf https://download.geofabrik.de/europe/luxembourg-260707.osm.pbf
echo luxembourg-260707.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/sea-20260705100000.zip" ] || wcurl -o $CACHE/sea-20260705100000.zip http://osm.thkukuk.de/data/sea-20260705100000.zip
echo sea-20260705100000.zip > names/sea
...
[ -f "$CACHE/3254c7-6560f7190efdf.zip" ] || wcurl -o $CACHE/3254c7-6560f7190efdf.zip http://download.geonames.org/export/dump/cities15000.zip
echo 3254c7-6560f7190efdf.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
