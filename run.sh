...
[ -f "$CACHE/belgium-260624.osm.pbf" ] || wcurl -o $CACHE/belgium-260624.osm.pbf https://download.geofabrik.de/europe/belgium-260624.osm.pbf
echo belgium-260624.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260624.osm.pbf" ] || wcurl -o $CACHE/netherlands-260624.osm.pbf https://download.geofabrik.de/europe/netherlands-260624.osm.pbf
echo netherlands-260624.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260624.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260624.osm.pbf https://download.geofabrik.de/europe/luxembourg-260624.osm.pbf
echo luxembourg-260624.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/322150-65509f4fba6ae.zip" ] || wcurl -o $CACHE/322150-65509f4fba6ae.zip http://download.geonames.org/export/dump/cities15000.zip
echo 322150-65509f4fba6ae.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
