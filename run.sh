...
[ -f "$CACHE/belgium-260323.osm.pbf" ] || wcurl -o $CACHE/belgium-260323.osm.pbf https://download.geofabrik.de/europe/belgium-260323.osm.pbf
echo belgium-260323.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260323.osm.pbf" ] || wcurl -o $CACHE/netherlands-260323.osm.pbf https://download.geofabrik.de/europe/netherlands-260323.osm.pbf
echo netherlands-260323.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260324.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260324.osm.pbf https://download.geofabrik.de/europe/luxembourg-260324.osm.pbf
echo luxembourg-260324.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/sea-20260323230000.zip" ] || wcurl -o $CACHE/sea-20260323230000.zip http://osm.thkukuk.de/data/sea-20260323230000.zip
echo sea-20260323230000.zip > names/sea
...
[ -f "$CACHE/2ee253-64dd023629105.zip" ] || wcurl -o $CACHE/2ee253-64dd023629105.zip http://download.geonames.org/export/dump/cities15000.zip
echo 2ee253-64dd023629105.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
