...
[ -f "$CACHE/belgium-260721.osm.pbf" ] || wcurl -o $CACHE/belgium-260721.osm.pbf https://download.geofabrik.de/europe/belgium-260721.osm.pbf
echo belgium-260721.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260721.osm.pbf" ] || wcurl -o $CACHE/netherlands-260721.osm.pbf https://download.geofabrik.de/europe/netherlands-260721.osm.pbf
echo netherlands-260721.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260721.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260721.osm.pbf https://download.geofabrik.de/europe/luxembourg-260721.osm.pbf
echo luxembourg-260721.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/325e18-6572920e7dd8d.zip" ] || wcurl -o $CACHE/325e18-6572920e7dd8d.zip http://download.geonames.org/export/dump/cities15000.zip
echo 325e18-6572920e7dd8d.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
