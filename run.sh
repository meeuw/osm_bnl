...
[ -f "$CACHE/belgium-260810.osm.pbf" ] || wcurl -o $CACHE/belgium-260810.osm.pbf https://download.geofabrik.de/europe/belgium-260810.osm.pbf
echo belgium-260810.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260810.osm.pbf" ] || wcurl -o $CACHE/netherlands-260810.osm.pbf https://download.geofabrik.de/europe/netherlands-260810.osm.pbf
echo netherlands-260810.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260810.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260810.osm.pbf https://download.geofabrik.de/europe/luxembourg-260810.osm.pbf
echo luxembourg-260810.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/sea-20260809220000.zip" ] || wcurl -o $CACHE/sea-20260809220000.zip http://osm.thkukuk.de/data/sea-20260809220000.zip
echo sea-20260809220000.zip > names/sea
...
[ -f "$CACHE/326f0c-658bc2bcca2c7.zip" ] || wcurl -o $CACHE/326f0c-658bc2bcca2c7.zip http://download.geonames.org/export/dump/cities15000.zip
echo 326f0c-658bc2bcca2c7.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
