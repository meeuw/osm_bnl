...
[ -f "$CACHE/belgium-260627.osm.pbf" ] || wcurl -o $CACHE/belgium-260627.osm.pbf https://download.geofabrik.de/europe/belgium-260627.osm.pbf
echo belgium-260627.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260627.osm.pbf" ] || wcurl -o $CACHE/netherlands-260627.osm.pbf https://download.geofabrik.de/europe/netherlands-260627.osm.pbf
echo netherlands-260627.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260627.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260627.osm.pbf https://download.geofabrik.de/europe/luxembourg-260627.osm.pbf
echo luxembourg-260627.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/322620-655470d4ccf06.zip" ] || wcurl -o $CACHE/322620-655470d4ccf06.zip http://download.geonames.org/export/dump/cities15000.zip
echo 322620-655470d4ccf06.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
