...
[ -f "$CACHE/31ba47-64fee705bd7f7.zip" ] || wcurl -o $CACHE/31ba47-64fee705bd7f7.zip http://download.geonames.org/export/dump/cities15000.zip
echo 31ba47-64fee705bd7f7.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
