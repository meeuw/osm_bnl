...
[ -f "$CACHE/belgium-260719.osm.pbf" ] || wcurl -o $CACHE/belgium-260719.osm.pbf https://download.geofabrik.de/europe/belgium-260719.osm.pbf
echo belgium-260719.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260719.osm.pbf" ] || wcurl -o $CACHE/netherlands-260719.osm.pbf https://download.geofabrik.de/europe/netherlands-260719.osm.pbf
echo netherlands-260719.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260719.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260719.osm.pbf https://download.geofabrik.de/europe/luxembourg-260719.osm.pbf
echo luxembourg-260719.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/325d02-65700e02dcc9a.zip" ] || wcurl -o $CACHE/325d02-65700e02dcc9a.zip http://download.geonames.org/export/dump/cities15000.zip
echo 325d02-65700e02dcc9a.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
