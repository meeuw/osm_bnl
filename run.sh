...
[ -f "$CACHE/belgium-260710.osm.pbf" ] || wcurl -o $CACHE/belgium-260710.osm.pbf https://download.geofabrik.de/europe/belgium-260710.osm.pbf
echo belgium-260710.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260710.osm.pbf" ] || wcurl -o $CACHE/netherlands-260710.osm.pbf https://download.geofabrik.de/europe/netherlands-260710.osm.pbf
echo netherlands-260710.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260710.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260710.osm.pbf https://download.geofabrik.de/europe/luxembourg-260710.osm.pbf
echo luxembourg-260710.osm.pbf > names/geofabrik-luxembourg
[ -f "$CACHE/bounds-20260710.zip" ] || wcurl -o $CACHE/bounds-20260710.zip http://osm.thkukuk.de/data/bounds-20260710.zip
echo bounds-20260710.zip > names/bounds
[ -f "$CACHE/sea-20260710080000.zip" ] || wcurl -o $CACHE/sea-20260710080000.zip http://osm.thkukuk.de/data/sea-20260710080000.zip
echo sea-20260710080000.zip > names/sea
...
[ -f "$CACHE/3256c6-6564bcd4129fa.zip" ] || wcurl -o $CACHE/3256c6-6564bcd4129fa.zip http://download.geonames.org/export/dump/cities15000.zip
echo 3256c6-6564bcd4129fa.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
