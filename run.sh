...
[ -f "$CACHE/luxembourg-260313.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260313.osm.pbf https://download.geofabrik.de/europe/luxembourg-260313.osm.pbf
echo luxembourg-260313.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/2ed38d-64cf2cd911e86.zip" ] || wcurl -o $CACHE/2ed38d-64cf2cd911e86.zip http://download.geonames.org/export/dump/cities15000.zip
echo 2ed38d-64cf2cd911e86.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
