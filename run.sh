...
[ -f "$CACHE/belgium-260327.osm.pbf" ] || wcurl -o $CACHE/belgium-260327.osm.pbf https://download.geofabrik.de/europe/belgium-260327.osm.pbf
echo belgium-260327.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260327.osm.pbf" ] || wcurl -o $CACHE/netherlands-260327.osm.pbf https://download.geofabrik.de/europe/netherlands-260327.osm.pbf
echo netherlands-260327.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260327.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260327.osm.pbf https://download.geofabrik.de/europe/luxembourg-260327.osm.pbf
echo luxembourg-260327.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/sea-20260326110000.zip" ] || wcurl -o $CACHE/sea-20260326110000.zip http://osm.thkukuk.de/data/sea-20260326110000.zip
echo sea-20260326110000.zip > names/sea
...
[ -f "$CACHE/2ee597-64e0c6d3091ba.zip" ] || wcurl -o $CACHE/2ee597-64e0c6d3091ba.zip http://download.geonames.org/export/dump/cities15000.zip
echo 2ee597-64e0c6d3091ba.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
