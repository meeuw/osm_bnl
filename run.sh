...
[ -f "$CACHE/belgium-260403.osm.pbf" ] || wcurl -o $CACHE/belgium-260403.osm.pbf https://download.geofabrik.de/europe/belgium-260403.osm.pbf
echo belgium-260403.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260403.osm.pbf" ] || wcurl -o $CACHE/netherlands-260403.osm.pbf https://download.geofabrik.de/europe/netherlands-260403.osm.pbf
echo netherlands-260403.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260403.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260403.osm.pbf https://download.geofabrik.de/europe/luxembourg-260403.osm.pbf
echo luxembourg-260403.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/sea-20260402220000.zip" ] || wcurl -o $CACHE/sea-20260402220000.zip http://osm.thkukuk.de/data/sea-20260402220000.zip
echo sea-20260402220000.zip > names/sea
...
[ -f "$CACHE/2efb31-64e99001e6dc4.zip" ] || wcurl -o $CACHE/2efb31-64e99001e6dc4.zip http://download.geonames.org/export/dump/cities15000.zip
echo 2efb31-64e99001e6dc4.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
