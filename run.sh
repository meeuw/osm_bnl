...
[ -f "$CACHE/belgium-260831.osm.pbf" ] || wcurl -o $CACHE/belgium-260831.osm.pbf https://download.geofabrik.de/europe/belgium-260831.osm.pbf
echo belgium-260831.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260831.osm.pbf" ] || wcurl -o $CACHE/netherlands-260831.osm.pbf https://download.geofabrik.de/europe/netherlands-260831.osm.pbf
echo netherlands-260831.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260831.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260831.osm.pbf https://download.geofabrik.de/europe/luxembourg-260831.osm.pbf
echo luxembourg-260831.osm.pbf > names/geofabrik-luxembourg
[ -f "$CACHE/bounds-20260828.zip" ] || wcurl -o $CACHE/bounds-20260828.zip http://osm.thkukuk.de/data/bounds-20260828.zip
echo bounds-20260828.zip > names/bounds
[ -f "$CACHE/sea-20260830220000.zip" ] || wcurl -o $CACHE/sea-20260830220000.zip http://osm.thkukuk.de/data/sea-20260830220000.zip
echo sea-20260830220000.zip > names/sea
...
[ -f "$CACHE/328c04-65a623cd0b5e7.zip" ] || wcurl -o $CACHE/328c04-65a623cd0b5e7.zip http://download.geonames.org/export/dump/cities15000.zip
echo 328c04-65a623cd0b5e7.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
