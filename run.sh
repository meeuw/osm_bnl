...
[ -f "$CACHE/belgium-260713.osm.pbf" ] || wcurl -o $CACHE/belgium-260713.osm.pbf https://download.geofabrik.de/europe/belgium-260713.osm.pbf
echo belgium-260713.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260713.osm.pbf" ] || wcurl -o $CACHE/netherlands-260713.osm.pbf https://download.geofabrik.de/europe/netherlands-260713.osm.pbf
echo netherlands-260713.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260713.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260713.osm.pbf https://download.geofabrik.de/europe/luxembourg-260713.osm.pbf
echo luxembourg-260713.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/sea-20260712220000.zip" ] || wcurl -o $CACHE/sea-20260712220000.zip http://osm.thkukuk.de/data/sea-20260712220000.zip
echo sea-20260712220000.zip > names/sea
...
[ -f "$CACHE/325953-656885ee7c5d2.zip" ] || wcurl -o $CACHE/325953-656885ee7c5d2.zip http://download.geonames.org/export/dump/cities15000.zip
echo 325953-656885ee7c5d2.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
