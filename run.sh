...
[ -f "$CACHE/belgium-260905.osm.pbf" ] || wcurl -o $CACHE/belgium-260905.osm.pbf https://download.geofabrik.de/europe/belgium-260905.osm.pbf
echo belgium-260905.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260904.osm.pbf" ] || wcurl -o $CACHE/netherlands-260904.osm.pbf https://download.geofabrik.de/europe/netherlands-260904.osm.pbf
echo netherlands-260904.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260905.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260905.osm.pbf https://download.geofabrik.de/europe/luxembourg-260905.osm.pbf
echo luxembourg-260905.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/sea-20260904220000.zip" ] || wcurl -o $CACHE/sea-20260904220000.zip http://osm.thkukuk.de/data/sea-20260904220000.zip
echo sea-20260904220000.zip > names/sea
...
[ -f "$CACHE/3295ea-65ac765ee2ee4.zip" ] || wcurl -o $CACHE/3295ea-65ac765ee2ee4.zip http://download.geonames.org/export/dump/cities15000.zip
echo 3295ea-65ac765ee2ee4.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
