...
[ -f "$CACHE/belgium-260913.osm.pbf" ] || wcurl -o $CACHE/belgium-260913.osm.pbf https://download.geofabrik.de/europe/belgium-260913.osm.pbf
echo belgium-260913.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260913.osm.pbf" ] || wcurl -o $CACHE/netherlands-260913.osm.pbf https://download.geofabrik.de/europe/netherlands-260913.osm.pbf
echo netherlands-260913.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260913.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260913.osm.pbf https://download.geofabrik.de/europe/luxembourg-260913.osm.pbf
echo luxembourg-260913.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/sea-20260912220000.zip" ] || wcurl -o $CACHE/sea-20260912220000.zip http://osm.thkukuk.de/data/sea-20260912220000.zip
echo sea-20260912220000.zip > names/sea
...
[ -f "$CACHE/3298bd-65b689a3535fe.zip" ] || wcurl -o $CACHE/3298bd-65b689a3535fe.zip http://download.geonames.org/export/dump/cities15000.zip
echo 3298bd-65b689a3535fe.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
