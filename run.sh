...
[ -f "$CACHE/belgium-260610.osm.pbf" ] || wcurl -o $CACHE/belgium-260610.osm.pbf https://download.geofabrik.de/europe/belgium-260610.osm.pbf
echo belgium-260610.osm.pbf > names/geofabrik-belgium
[ -f "$CACHE/netherlands-260610.osm.pbf" ] || wcurl -o $CACHE/netherlands-260610.osm.pbf https://download.geofabrik.de/europe/netherlands-260610.osm.pbf
echo netherlands-260610.osm.pbf > names/geofabrik-netherlands
[ -f "$CACHE/luxembourg-260610.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260610.osm.pbf https://download.geofabrik.de/europe/luxembourg-260610.osm.pbf
echo luxembourg-260610.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/320a1d-653f055dcc582.zip" ] || wcurl -o $CACHE/320a1d-653f055dcc582.zip http://download.geonames.org/export/dump/cities15000.zip
echo 320a1d-653f055dcc582.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
