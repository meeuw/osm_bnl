...
[ -f "$CACHE/luxembourg-260328.osm.pbf" ] || wcurl -o $CACHE/luxembourg-260328.osm.pbf https://download.geofabrik.de/europe/luxembourg-260328.osm.pbf
echo luxembourg-260328.osm.pbf > names/geofabrik-luxembourg
...
[ -f "$CACHE/sea-20260327230000.zip" ] || wcurl -o $CACHE/sea-20260327230000.zip http://osm.thkukuk.de/data/sea-20260327230000.zip
echo sea-20260327230000.zip > names/sea
...
[ -f "$CACHE/2ee5da-64e210215e3fc.zip" ] || wcurl -o $CACHE/2ee5da-64e210215e3fc.zip http://download.geonames.org/export/dump/cities15000.zip
echo 2ee5da-64e210215e3fc.zip > names/cities15000
MERGED=$(cat \
  $CACHE/$(< names/osmosis) \
